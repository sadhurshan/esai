...
class MaintenanceProcedurePolicy
{
    ...
    public function view(User $user, MaintenanceProcedure $procedure): bool
    {
        return $this->canView($user) && $this->matchesCompany($user, $procedure->company_id);
    }
    ...
    public function update(User $user, MaintenanceProcedure $procedure): bool
    {
        return $this->canManage($user) && $this->matchesCompany($user, $procedure->company_id);
    }

    public function delete(User $user, MaintenanceProcedure $procedure): bool
    {
        return $this->canManage($user) && $this->matchesCompany($user, $procedure->company_id);
    }
