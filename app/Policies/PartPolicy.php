...
class PartPolicy
{
    ...
    private const MANAGE_ROLES = ['owner', 'buyer_admin', 'ops_admin'];
    ...
    {
        return $this->canView($user) && $this->matchesCompany($user, $part->company_id);
    }
    ...
    {
        return $this->canManage($user) && $this->matchesCompany($user, $part->company_id);
    }
