...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasTable('company_user') && Schema::hasColumn('company_user', 'role')) {
            DB::statement("ALTER TABLE company_user MODIFY COLUMN role ENUM('owner','buyer_admin','buyer_requester','supplier_admin','supplier_estimator','finance','platform_super','platform_support') NOT NULL DEFAULT 'buyer_admin'");
        }
    }
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('company_user') && Schema::hasColumn('company_user', 'role')) {
            DB::statement("ALTER TABLE company_user MODIFY COLUMN role ENUM('buyer_admin','buyer_requester','supplier_admin','supplier_estimator','finance','platform_super','platform_support') NOT NULL DEFAULT 'buyer_admin'");
        }
    }
};
