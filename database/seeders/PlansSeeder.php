...
class PlansSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('plans')->upsert(
            $payload,
            ['code'],
            ['name', 'price_usd', 'rfqs_per_month', 'invoices_per_month', 'users_max', 'storage_gb', 'erp_integrations_max', 'analytics_enabled', 'analytics_history_months', 'risk_scores_enabled', 'risk_history_months', 'approvals_enabled', 'approval_levels_limit', 'rma_enabled', 'rma_monthly_limit', 'credit_notes_enabled', 'supplier_invoicing_enabled', 'global_search_enabled', 'quotes_enabled', 'quote_revisions_enabled', 'digital_twin_enabled', 'maintenance_enabled', 'inventory_enabled', 'inventory_history_months', 'pr_enabled', 'multi_currency_enabled', 'tax_engine_enabled', 'localization_enabled', 'exports_enabled', 'export_row_limit', 'data_export_enabled', 'export_history_days', 'updated_at']
        );
    }
}
