...
export function OrderLinesTable({
    ...
    const derivedTotals = useMemo(() => {
        ...
        return lines.reduce(
            (acc, line) => {
                ...
                const subtotal =
                    unitMinor !== null ? unitMinor * line.qtyOrdered : 0;
    ...
    const resolvedTotals = {
        ...
        total:
            totals?.totalMinor ??
            (lines.length ? derivedTotals.total : undefined),
    };
    ...
    return (
        <Card className={cn('border-border/70', className)}>
            <CardHeader>
                ...
                <CardDescription>
                    Quantities, allocations, and shipment progress per SKU.
                </CardDescription>
            </CardHeader>
            <CardContent>
                {lines.length === 0 ? (
