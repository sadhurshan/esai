...
import { AdminDigitalTwinApi, type AdminDigitalTwinDetailResponse, type AdminDigitalTwinDetail } from '@/sdk';
...
export type UseAdminDigitalTwinResult = UseQueryResult<AdminDigitalTwinDetailResponse> & {
...
export function useAdminDigitalTwin(
	...
	const queryKey = queryKeys.digitalTwins.adminDetail(resolvedId ?? 'pending');
