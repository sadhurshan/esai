...
import {
    AdminDigitalTwinApi,
    type AdminDigitalTwinIndexResponse,
    type AdminDigitalTwinListItem,
} from '@/sdk';
...
type UseAdminDigitalTwinsQueryResult =
    UseQueryResult<AdminDigitalTwinIndexResponse>;
