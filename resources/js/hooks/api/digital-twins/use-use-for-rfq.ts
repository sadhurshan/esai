...
import {
    ...
    type DigitalTwinUseForRfqResponse,
} from '@/sdk';
...
export function useUseForRfq(
    ...
    return useMutation({
        ...
        mutationFn: async ({ digitalTwinId }) =>
            api.useDigitalTwinForRfq(digitalTwinId),
        ...options,
        onSuccess: (data, variables, onMutateResult, context) => {
            queryClient.invalidateQueries({
                queryKey: queryKeys.digitalTwins.libraryRoot(),
            });
            queryClient.invalidateQueries({
                queryKey: queryKeys.digitalTwins.libraryDetail(
