...
export function useUpdateItem(): UseMutationResult<InventoryItemDetail, HttpError | Error, UpdateItemInput> {
    ...
    return useMutation<InventoryItemDetail, HttpError | Error, UpdateItemInput>({
        mutationFn: async (input) => {
            ...
            const response = (await inventoryApi.updateItem(input.id, payload)) as Record<string, unknown>;
