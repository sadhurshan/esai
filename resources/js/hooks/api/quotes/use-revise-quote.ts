...
import type { ApiSuccessResponse, HttpError, SubmitQuoteRevisionRequest } from '@/sdk';
...
export function useReviseQuote(): UseMutationResult<ApiSuccessResponse, HttpError, ReviseQuoteVariables> {
