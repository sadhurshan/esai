export const queryKeys = {
    ai: {
        workflows: {
            list: (params?: Record<string, unknown>) =>
                ['ai', 'workflows', 'list', params ?? {}] as const,
            step: (workflowId: string) =>
                ['ai', 'workflows', 'step', workflowId] as const,
        },
        chat: {
            root: () => ['ai', 'chat'] as const,
            threads: (params?: Record<string, unknown>) =>
                ['ai', 'chat', 'threads', params ?? {}] as const,
            thread: (threadId: string | number) =>
                ['ai', 'chat', 'threads', 'detail', String(threadId)] as const,
        },
    },
    dashboard: {
    ...
    quotes: {
        ...
        rfq: (rfqId: string | number) =>
            ['quotes', 'rfq', String(rfqId)] as const,
        list: (rfqId: string | number, filters?: Record<string, unknown>) =>
            ['quotes', 'rfq', String(rfqId), 'list', filters ?? {}] as const,
        compare: (rfqId: string | number) =>
            ['quotes', 'rfq', String(rfqId), 'compare'] as const,
        detail: (quoteId: string | number) =>
            ['quotes', 'detail', String(quoteId)] as const,
        lines: (quoteId: string | number) =>
            ['quotes', 'lines', String(quoteId)] as const,
        ...
        supplierList: (params?: Record<string, unknown>) =>
            ['quotes', 'supplier', 'list', params ?? {}] as const,
    },
    awards: {
        root: () => ['awards'] as const,
        candidates: (rfqId: string | number) =>
            ['awards', 'rfq', String(rfqId), 'candidates'] as const,
        summary: (rfqId: string | number) =>
            ['awards', 'rfq', String(rfqId), 'summary'] as const,
    },
    suppliers: {
        list: (params?: Record<string, unknown>) =>
            ['suppliers', 'list', params ?? {}] as const,
        detail: (id: string | number) =>
            ['suppliers', 'detail', String(id)] as const,
    },
    rfps: {
        root: () => ['rfps'] as const,
        list: (params?: Record<string, unknown>) =>
            ['rfps', 'list', params ?? {}] as const,
        detail: (id: string | number) =>
            ['rfps', 'detail', String(id)] as const,
        proposals: (id: string | number) =>
            ['rfps', 'detail', String(id), 'proposals'] as const,
    },
    rfqs: {
        root: () => ['rfqs'] as const,
        list: (params?: Record<string, unknown>) =>
        ...
        invitations: (rfqId: string | number) =>
            ['rfqs', 'invitations', rfqId] as const,
        lines: (rfqId: string | number) => ['rfqs', 'lines', rfqId] as const,
        suppliers: (rfqId: string | number) =>
            ['rfqs', 'suppliers', rfqId] as const,
        clarifications: (rfqId: string | number) =>
            ['rfqs', 'clarifications', rfqId] as const,
        timeline: (rfqId: string | number) =>
            ['rfqs', 'timeline', rfqId] as const,
        attachments: (rfqId: string | number) =>
            ['rfqs', 'attachments', rfqId] as const,
    },
    money: {
        settings: () => ['money', 'settings'] as const,
        taxCodes: (params?: Record<string, unknown>) =>
            ['money', 'tax-codes', params ?? {}] as const,
    },
    localization: {
        settings: () => ['localization', 'settings'] as const,
        convert: (params: { from: string; to: string }) =>
            ['localization', 'convert', params] as const,
        uoms: (dimension?: string | null) =>
            ['localization', 'uoms', dimension ?? 'all'] as const,
    },
    settings: {
    ...
    companyInvitations: {
        list: (params?: Record<string, unknown>) =>
            ['company-invitations', 'list', params ?? {}] as const,
    },
    companyMembers: {
        list: (params?: Record<string, unknown>) =>
            ['company-members', 'list', params ?? {}] as const,
    },
    companyRoleTemplates: {
        list: (params?: Record<string, unknown>) =>
            ['company-role-templates', 'list', params ?? {}] as const,
    },
    orders: {
        list: (params?: Record<string, unknown>) =>
            ['orders', 'list', params ?? {}] as const,
        supplierList: (params?: Record<string, unknown>) =>
            ['orders', 'supplier', 'list', params ?? {}] as const,
        supplierDetail: (id: string | number) =>
            ['orders', 'supplier', 'detail', String(id)] as const,
        buyerList: (params?: Record<string, unknown>) =>
            ['orders', 'buyer', 'list', params ?? {}] as const,
        buyerDetail: (id: string | number) =>
            ['orders', 'buyer', 'detail', String(id)] as const,
    },
    downloads: {
        root: () => ['downloads'] as const,
        list: (params?: Record<string, unknown>) =>
            ['downloads', 'list', params ?? {}] as const,
    },
    analytics: {
        overview: () => ['analytics', 'overview'] as const,
        forecastReport: (params?: Record<string, unknown>) =>
            ['analytics', 'forecast-report', params ?? {}] as const,
        supplierPerformanceReport: (params?: Record<string, unknown>) =>
            ['analytics', 'supplier-performance-report', params ?? {}] as const,
        supplierOptions: (params?: Record<string, unknown>) =>
            ['analytics', 'supplier-options', params ?? {}] as const,
    },
    purchaseOrders: {
        ...
        changeOrders: (purchaseOrderId: number) =>
            ['purchase-orders', 'change-orders', purchaseOrderId] as const,
        events: (purchaseOrderId: number) =>
            ['purchase-orders', 'events', purchaseOrderId] as const,
    },
    invoices: {
        list: (params?: Record<string, unknown>) =>
            ['invoices', 'list', params ?? {}] as const,
        detail: (id: number | string) =>
            ['invoices', 'detail', String(id)] as const,
        supplierList: (params?: Record<string, unknown>) =>
            ['invoices', 'supplier', 'list', params ?? {}] as const,
        supplierDetail: (id: number | string) =>
            ['invoices', 'supplier', 'detail', String(id)] as const,
    },
    companies: {
    ...
    documents: {
        cadExtraction: (documentId: string | number) =>
            ['documents', 'cad-extraction', String(documentId)] as const,
    },
    receiving: {
        root: () => ['receiving'] as const,
        list: (params?: Record<string, unknown>) =>
            ['receiving', 'grns', 'list', params ?? {}] as const,
        detail: (id: string | number) =>
            ['receiving', 'grns', 'detail', String(id)] as const,
    },
    matching: {
        candidates: (params?: Record<string, unknown>) =>
            ['matching', 'candidates', params ?? {}] as const,
    },
    notifications: {
        list: (params?: Record<string, unknown>) =>
    ...
    risk: {
        root: () => ['risk'] as const,
        list: (params?: Record<string, unknown>) =>
            ['risk', 'list', params ?? {}] as const,
        detail: (supplierId: string | number) =>
            ['risk', 'detail', String(supplierId)] as const,
    },
    events: {
        deliveries: (params?: Record<string, unknown>) =>
            ['events', 'deliveries', params ?? {}] as const,
    },
    credits: {
        root: () => ['credits'] as const,
        list: (params?: Record<string, unknown>) =>
            ['credits', 'list', params ?? {}] as const,
        detail: (id: string | number) =>
            ['credits', 'detail', String(id)] as const,
    },
    digitalTwins: {
        libraryRoot: () => ['digital-twins', 'library'] as const,
        libraryList: (params?: Record<string, unknown>) =>
            ['digital-twins', 'library', 'list', params ?? {}] as const,
        libraryDetail: (id: string | number) =>
            ['digital-twins', 'library', 'detail', String(id)] as const,
        categories: () => ['digital-twins', 'library', 'categories'] as const,
        adminRoot: () => ['digital-twins', 'admin'] as const,
        adminList: (params?: Record<string, unknown>) =>
            ['digital-twins', 'admin', 'list', params ?? {}] as const,
        adminDetail: (id: string | number) =>
            ['digital-twins', 'admin', 'detail', String(id)] as const,
        adminCategories: () =>
            ['digital-twins', 'admin', 'categories'] as const,
        adminAuditEvents: (id: string | number) =>
            ['digital-twins', 'admin', 'audit-events', String(id)] as const,
    },
    inventory: {
        ...
        item: (id: string | number) =>
            ['inventory', 'items', String(id)] as const,
        locations: (params?: Record<string, unknown>) =>
            ['inventory', 'locations', params ?? {}] as const,
        movementsList: (params?: Record<string, unknown>) =>
            ['inventory', 'movements', params ?? {}] as const,
        movement: (id: string | number) =>
            ['inventory', 'movements', String(id)] as const,
    ...
    admin: {
        ...
        aiEvents: (filters?: Record<string, unknown>) =>
            ['admin', 'ai-events', filters ?? {}] as const,
        aiModelMetrics: (filters?: Record<string, unknown>) =>
            ['admin', 'ai-model-metrics', filters ?? {}] as const,
        aiTrainingJobs: (filters?: Record<string, unknown>) =>
            ['admin', 'ai-training', 'jobs', filters ?? {}] as const,
...
export type QueryKey = ReturnType<
    ...
    | (typeof queryKeys)['documents']['cadExtraction']
