...
export function AdminDigitalTwinCreatePage() {
    ...
    useEffect(() => {
        ...
        if (!current) {
            form.setValue('categoryId', String(categoryOptions[0].value), {
                shouldDirty: false,
            });
        }
    ...
    const canSubmit =
        !isSubmitting &&
        (categoryOptions.length > 0 || Boolean(form.getValues('categoryId')));
            ...
            {!categoriesQuery.isLoading && categoryOptions.length === 0 ? (
                <Alert>
                    ...
                    <AlertDescription>
                        ...
                        publishing content. You can manage categories from the
                        admin dashboard.
                    </AlertDescription>
                </Alert>
            ) : null}
                    ...
                    <CardContent className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            {form.formState.errors.code ? (
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Appears in admin tools, hidden from buyers.
                                </p>
                            )}
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            {form.formState.errors.summary ? (
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Buyers see this description in the library.
                                </p>
                            )}
                        </div>
                        <div className="space-y-2 md:col-span-2">
                            ...
                            {form.formState.errors.revisionNotes ? (
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Helps buyers understand the delta from prior
                                    releases.
                                </p>
                            )}
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            {tags.length === 0 ? (
                                <p className="text-sm text-muted-foreground">
                                    Add discoverability tags like materials or
                                    processes.
                                </p>
                            ) : null}
                        </div>
                ...
                <Card className="border-border/70">
                    ...
                    <CardContent className="space-y-4">
                        {specFields.map((field, index) => (
                            ...
                            >
                                <div className="space-y-2">
                                    <Label htmlFor={`spec-name-${field.id}`}>
                                        Name
                                    </Label>
                                    <Input
                                    ...
                                    {specErrors[index]?.name ? (
                                        <p className="text-xs text-destructive">
                                            {specErrors[index]?.name?.message}
                                        </p>
                                    ) : null}
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor={`spec-value-${field.id}`}>
                                        Value
                                    </Label>
                                    <Input
                                    ...
                                    {specErrors[index]?.value ? (
                                        <p className="text-xs text-destructive">
                                            {specErrors[index]?.value?.message}
                                        </p>
                                    ) : null}
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        {...form.register(`specs.${index}.uom`)}
                                    />
                                    {specErrors[index]?.uom ? (
                                        <p className="text-xs text-destructive">
                                            {specErrors[index]?.uom?.message}
                                        </p>
                                    ) : null}
                                </div>
