...
export function CreditNoteListPage() {
    ...
    const paginationMeta = (creditNotesQuery.data?.meta ??
        null) as PaginationMeta | null;
    ...
    const columns: DataTableColumn<CreditNoteSummary>[] = useMemo(
        () => [
            ...
            },
            {
                ...
                title: 'Created',
                render: (credit) =>
                    formatDate(credit.createdAt ?? credit.issuedAt),
            },
            {
                key: 'currency',
                title: 'Currency',
            ...
            },
            {
                ...
                render: (credit) => (
                    <Badge
                        variant={STATUS_VARIANTS[credit.status] ?? 'outline'}
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Track credits issued against invoices and keep supplier
                        balances up to date.
                    </p>
                </div>
                <div className="flex flex-wrap gap-2">
                    ...
                    >
                        <NotepadText className="mr-2 h-4 w-4" /> Create from
                        invoice
                    </Button>
                </div>
            </div>
                ...
                <CardContent className="grid gap-4 py-6 md:grid-cols-5">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Filter credits by supplier acknowledgement.
                        </p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-xs font-medium text-muted-foreground uppercase">
                    ...
                    <div className="flex flex-wrap gap-2 md:col-span-5">
                        ...
                        <Button
                            ...
                            disabled
                        >
                            <Filter className="mr-2 h-4 w-4" /> Saved filters
                            (coming soon)
                        </Button>
                    </div>
                </CardContent>
