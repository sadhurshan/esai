...
export function BuyerOrderDetailPage() {
    ...
    const buyerOrderQuery = useBuyerOrder(orderId ?? null, {
            ...
            <Card className="border-border/70">
                <CardHeader className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div className="space-y-1">
                        ...
                        <CardDescription>
                            Mirror of PO #{order.poId}. Monitor acknowledgements
                            and shipment events from the supplier portal.
                        </CardDescription>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                <Card className="border-border/70">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Reference addresses and instructions shared with the
                            supplier.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="border-border/70">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Jump to the original purchase order for change
                            orders or receiving.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="flex flex-wrap gap-3 text-sm">
                        <Button asChild variant="outline" size="sm">
                            <Link
                                ...
                                className="gap-2"
                            >
                                <Package className="h-4 w-4" /> Open purchase
                                order
                            </Link>
                        </Button>
                        <Button asChild variant="ghost" size="sm">
                            <Link
                                to={`/app/receiving?poId=${order.poId}`}
                                className="gap-2"
                            >
                                <ExternalLink className="h-4 w-4" /> Receiving
                                workspace
                            </Link>
                        </Button>
                    </CardContent>
                ...
                <TabsContent value="shipments">
                    <Card className="border-border/70">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Tracking numbers, carriers, and delivery
                                confirmations from the supplier.
                            </CardDescription>
                        </CardHeader>
                ...
                <TabsContent value="timeline">
                    <Card className="border-border/70">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Combined acknowledgement, shipment, and status
                                activity.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
