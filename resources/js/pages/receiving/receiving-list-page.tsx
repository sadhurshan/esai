    ...
    const columns: DataTableColumn<GoodsReceiptNoteSummary>[] = useMemo(
        () => [
            ...
            },
            {
                ...
                title: 'Lines',
                render: (grn) =>
                    typeof grn.linesCount === 'number'
                        ? formatNumber(grn.linesCount, {
            ...
            },
            {
                ...
                render: (grn) => (
                    <Badge variant="outline" className="font-mono text-xs">
                        {formatNumber(grn.attachmentsCount ?? 0, {
                            maximumFractionDigits: 0,
                        })}
                    </Badge>
                ),
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Record goods receipt notes and reconcile deliveries
                ...
                <Button
                    type="button"
                    size="sm"
                    onClick={() => navigate('/app/receiving/new')}
                >
                ...
                <CardContent className="grid gap-4 py-6 md:grid-cols-5">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Filter GRNs by supplier directory entries.
                        </p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-xs font-medium text-muted-foreground uppercase">
