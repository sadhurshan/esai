...
const CHANNEL_OPTIONS: {
...
}[] = [
    {
        value: 'both',
        label: 'Email + push',
        description: 'Send email and in-app/push notifications.',
    },
    {
        value: 'email',
        label: 'Email only',
        description: 'Send email notifications only.',
    },
    {
        value: 'push',
        label: 'Push only',
        description: 'Send only in-app/push notifications.',
    },
];
...
const DIGEST_OPTIONS: {
...
}[] = [
    {
        value: 'none',
        label: 'Realtime',
        description: 'Deliver every event immediately.',
    },
    {
        value: 'daily',
        label: 'Daily digest',
        description: 'Bundle events into a daily summary.',
    },
    {
        value: 'weekly',
        label: 'Weekly digest',
        description: 'Bundle events into a weekly summary.',
    },
];
        ...
        events: [
            {
                ...
                label: 'RFQ published',
                description: 'When a new RFQ is published or reopened.',
            },
            {
            ...
            },
            {
                ...
                description:
                    'Buyers extend the submission deadline for an RFQ.',
            },
            {
        ...
        events: [
            {
                ...
                description: 'A supplier submits a quote response.',
            },
            {
        ...
        events: [
            {
                ...
                description: 'A PO is released to a supplier.',
            },
            {
                eventType: 'grn_posted',
                label: 'Goods received',
                description: 'Receiving logs a GRN for your PO.',
            },
        ],
    },
    {
        ...
        events: [
            {
                ...
                description: 'New invoice received from supplier.',
            },
            {
                eventType: 'invoice_status_changed',
                label: 'Invoice status updated',
                description:
                    'An AP reviewer moves an invoice forward or backward.',
            },
        ],
    },
    {
        ...
        events: [
            ...
            },
            {
                ...
                description:
                    'Long-running analytics reports finish processing.',
            },
        ],
    },
    {
        ...
        events: [
            {
                eventType: 'rma.raised',
                label: 'RMA raised',
                description: 'A return material authorization is created.',
            },
            {
            ...
            {
                eventType: 'rma.closed',
                label: 'RMA closed',
                description: 'The RMA cycle is completed.',
            },
        ],
    },
];
...
function PreferenceRow({
    ...
    const [digest, setDigest] = useState<NotificationDigestFrequency>(
        () => value.digest,
    );
        ...
        <div className="grid gap-4 rounded-lg border p-4 md:grid-cols-[2fr_1fr_1fr_auto] md:items-center">
            ...
            <div>
                ...
                <Select
                    value={channel}
                    onValueChange={(next) =>
                        setChannel(next as NotificationChannel)
                    }
                    disabled={isSaving}
                >
                    <SelectTrigger>
            ...
            <div>
                ...
                <Select
                    value={digest}
                    onValueChange={(next) =>
                        setDigest(next as NotificationDigestFrequency)
                    }
                    disabled={isSaving}
                >
                    <SelectTrigger>
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-muted-foreground">
                    Choose how and when you are notified for RFQs, quotes,
                    operations, and platform alerts. Preferences apply only to
                    your user profile.
                </p>
            </div>
