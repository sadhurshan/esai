...
const STATUS_META = {
    ...
    pending: {
        ...
        description:
            'Our team is reviewing your supplier application. Expect an update soon.',
        icon: Clock,
    ...
    approved: {
        label: 'Approved',
        description:
            'Supplier tooling is active. You can respond to RFQs and manage your profile.',
        icon: ShieldCheck,
    ...
    suspended: {
        label: 'Suspended',
        description:
            'Supplier access is temporarily disabled. Contact support for next steps.',
        icon: AlertCircle,
        badge: 'destructive' as const,
    },
};
...
export function SupplierWaitingPage() {
    ...
    const status = (supplierStatusData?.supplier_status ??
        'pending') as SupplierStatusKey;
        ...
        <div className="space-y-6">
            <div>
                ...
                <h1 className="text-2xl font-semibold tracking-tight">
                    Supplier approval in progress
                </h1>
                <p className="text-sm text-muted-foreground">
                    We are reviewing your supplier application. While you wait,
                    you can finish your supplier profile and upload compliance
                    documents.
                </p>
            </div>
            ...
            <Card>
                <CardHeader className="space-y-2">
                    ...
                    <CardDescription>
                        We will notify you as soon as your supplier account is
                        approved.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <Alert>
                        <AlertDescription>
                            Complete your supplier application and keep
                            documents current to speed up approval.
                        </AlertDescription>
                    </Alert>
                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        <Button asChild variant="outline">
                            <Link to="/app/supplier/company-profile">
