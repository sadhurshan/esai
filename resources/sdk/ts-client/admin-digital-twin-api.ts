...
export class AdminDigitalTwinApi extends runtime.BaseAPI {
	...
	private buildQuery(params: ListAdminDigitalTwinsRequest): runtime.HTTPQuery {
	...
	async listDigitalTwinsRaw(
		...
		return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue as AdminDigitalTwinIndexResponse);
	}
	...
	async getDigitalTwinRaw(
		...
		return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue as AdminDigitalTwinDetailResponse);
	}
	...
	async createDigitalTwinRaw(
		...
		return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue as AdminDigitalTwinMutationResponse);
	}
	...
	async createDigitalTwin(
		...
		const response = await this.createDigitalTwinRaw(payload, initOverrides);
		return await response.value();
	}
	...
	async updateDigitalTwin(
		...
		const response = await this.updateDigitalTwinRaw(digitalTwinId, payload, initOverrides);
		return await response.value();
	}
	...
	async deleteDigitalTwin(
		...
		const response = await this.deleteDigitalTwinRaw(digitalTwinId, initOverrides);
		return await response.value();
	}
	...
	async publishDigitalTwin(
		...
		const response = await this.publishDigitalTwinRaw(digitalTwinId, initOverrides);
		return await response.value();
	}
	...
	async archiveDigitalTwin(
		...
		const response = await this.archiveDigitalTwinRaw(digitalTwinId, initOverrides);
		return await response.value();
	}
	...
	async listDigitalTwinAuditEventsRaw(
		...
		return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue as AdminDigitalTwinAuditEventResponse);
	}
	...
	async listDigitalTwinAuditEvents(
		...
		const response = await this.listDigitalTwinAuditEventsRaw(digitalTwinId, requestParameters, initOverrides);
		return await response.value();
	}
	...
	async uploadDigitalTwinAssetRaw(
		...
		return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue as AdminDigitalTwinAssetResponse);
	}
	...
	async uploadDigitalTwinAsset(
		...
		const response = await this.uploadDigitalTwinAssetRaw(digitalTwinId, params, initOverrides);
		return await response.value();
	}
	...
	async deleteDigitalTwinAsset(
		...
		const response = await this.deleteDigitalTwinAssetRaw(digitalTwinId, assetId, initOverrides);
		return await response.value();
	}

	private buildCategoryQuery(params: ListAdminDigitalTwinCategoriesRequest): runtime.HTTPQuery {
		const query: runtime.HTTPQuery = {};
	...
	async listCategoriesRaw(
		...
		return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue as AdminDigitalTwinCategoryListResponse);
	}
	...
	async createCategoryRaw(
		...
		return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue as AdminDigitalTwinCategoryResponse);
	}
	...
	async updateCategory(
		...
		const response = await this.updateCategoryRaw(categoryId, payload, initOverrides);
		return await response.value();
	}
	...
	async deleteCategory(
		...
		const response = await this.deleteCategoryRaw(categoryId, initOverrides);
		return await response.value();
	}
}
