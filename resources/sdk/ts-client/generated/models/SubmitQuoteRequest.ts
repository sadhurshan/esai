 ...
 */
export function instanceOfSubmitQuoteRequest(value: object): value is SubmitQuoteRequest {
...
export function SubmitQuoteRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubmitQuoteRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function SubmitQuoteRequestToJSONTyped(value?: SubmitQuoteRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
